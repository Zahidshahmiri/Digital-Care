...
<body>
  ...
  <div id="content" class="container">
    <div class="heading" >
      ...
      <p class="lead"> Patient Registration</p>   
    </div>
...
<?php
   ...
   if(isset($_POST['submit']))
   {
     ...
     mysqli_query($con, "insert into patient (name,email,contact,address,password,blood,gender,age) values('".$_POST['name']."', '".$_POST['email']."' ,'".$_POST['contact']."', '".$_POST['address']."', '".$_POST['password']."', '".$_POST['blood']."' , '".$_POST['gender']."', '".$_POST['age']."')");
